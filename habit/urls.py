...
urlpatterns = [
    path('list/', TemplateView.as_view(template_name='habits/habit_list.html'), name='habit-list'),
    path('detail/<int:pk>', TemplateView.as_view(template_name='habits/habit_detail.html'), name='habit-detail'),
